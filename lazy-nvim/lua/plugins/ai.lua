-- Plugin configuration for Neovim using Lua.
-- Sets up AI, testing, debugging, and utility plugins with custom options and keymaps.
-- Designed for a powerful, extensible development environment.
return {
  {
